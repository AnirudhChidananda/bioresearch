...
"""
FastAPI application for the Bioresearch Environment.

This module creates an HTTP server that exposes the BioresearchEnvironment
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    This function enables running the server without Docker:
        ...
        python -m bioresearch.server.app
    ...
    multiple workers:
        uvicorn bioresearch.server.app:app --workers 4
    """
    import uvicorn
